...
function Header() {
	...
	const items = [
		...
		{
			label: (
				<Link to="/dashboard" className="py-1 px-1 w-full rounded-lg flex justify-start font-georgiaFont">
					<DashboardIcon className="h-full my-auto mr-4" />
					<span>Dashboard</span>
				</Link>
			),
			key: '1',
	...
	return (
		<>
			<div className="w-full relative bg-white border-b flex items-center border-gray-300 shadow-sm z-40">
